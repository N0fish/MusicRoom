...
- 500 — внутренняя ошибка.
Эндпоинт можно дёргать сколько угодно раз с одним токеном, но после первого успешного запроса токен обнуляется, и следующие вызовы вернут ошибку «invalid token».
